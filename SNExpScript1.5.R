...
word_window <- subset_by_window(dataset_clean, rezero = FALSE,
                                window_start_time = 900, window_end_time = 4900)
# Create time bins for both AOI
time_data <- make_time_sequence_data(word_window, 
                                     time_bin_size = 100, 
                                     aois = c("AOITarget", "AOIDistractor"))
# Plot both Target and Distractor looking patterns
plot(time_data)